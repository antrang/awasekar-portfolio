...
## IMPORTANT: Codebase Intelligence Instructions for awasekar-portfolio
...
Last indexed: 2026-04-27 (commit aab4236)
### Entry Points
- `src/App.tsx`
- `src/main.tsx`
### Tech Stack
...
|------|-------|-------------|-------|
| `src/components/WhatIDo.tsx` | 96.0th %ile | 2 | Sourabh Awasekar |
| `src/components/utils/initialFX.ts` | 92.0th %ile | 2 | Sourabh Awasekar |
| `src/components/Work.tsx` | 88.0th %ile | 2 | Sourabh Awasekar |
| `src/components/TechStack.tsx` | 84.0th %ile | 2 | Sourabh Awasekar |
| `src/components/SocialIcons.tsx` | 80.0th %ile | 2 | Sourabh Awasekar |
